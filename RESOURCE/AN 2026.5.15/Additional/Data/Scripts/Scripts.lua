...
function OnGunshipAircraftSwitchLocomotorCreated(self)
	ObjectCreateAndFireTempWeapon(self, "AlliedGunshipProvideRisingConditionWeapon")
	ObjectGrantUpgrade(self, "Upgrade_GunshipSwitchLocomotor")
end

function OnGunshipAircraftSwitchLocomotor(self)
	ObjectRemoveUpgrade(self, "Upgrade_GunshipSwitchLocomotor")
end

function OnUnitEnterWater(self)
      ObjectGrantUpgrade(self, "Uprade_OnWater")
end

function OnUnitExitWater(self)
      ObjectRemoveUpgrade(self, "Uprade_OnWater")
end

function OnUnitEnterAttacking(self)
      ExecuteAction("UNIT_CHANGE_OBJECT_STATUS", self, 129, 0)
end

function OnUnitExitAttacking(self)
      ExecuteAction("UNIT_CHANGE_OBJECT_STATUS", self, 129, 1)
end

function OnUnitUsingWeaponA(self)
      ExecuteAction("UNIT_CHANGE_OBJECT_STATUS", self, 128, 1)
end

function OnUnitNotUsingWeaponA(self)
      ExecuteAction("UNIT_CHANGE_OBJECT_STATUS", self, 128, 0)
end

function OnUnitRechargePause(self)
	ObjectDoSpecialPower(self, "SpecialPower_RechargeArmorPiercingShell")       
end

function OnUnitRechargeBoost(self)
	if not ObjectTestModelCondition(self, "FIRING_OR_RELOADING_C") then
		ObjectCreateAndFireTempWeapon(self, "SovietOverloadVehicleRechargeBoostConditionWeapon")
	end        
	ObjectDoSpecialPower(self, "SpecialPower_RechargeArmorPiercingShell")
end

function OnUnitEnterUser2(self)
      ObjectCreateAndFireTempWeapon(self, "SovietFighterAircraftIronPreConditionWeapon")
end

function OnUnitExitUser2(self)
      ObjectRemoveUpgrade(self, "Upgrade_SovietFighterAircraftIronEffect")
	  ExecuteAction("UNIT_CHANGE_OBJECT_STATUS", self, 128, 0)
end

function OnUnitExitUser3(self)
    if ObjectTestModelCondition(self, "USER_2") then
		ObjectGrantUpgrade(self, "Upgrade_SovietFighterAircraftIronEffect")
		ObjectCreateAndFireTempWeapon(self, "SovietFighterAircraftIronStartConditionWeapon")
	end
end

function OnUnitExitIronTimer(self)
      ObjectRemoveUpgrade(self, "Upgrade_SovietFighterAircraftIronEffect")
end